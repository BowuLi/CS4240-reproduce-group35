...
metric_average_file = 'metric_average_fuji20NikonD850.txt'
# Intermediate details for the test images, such as estimated amplification will be saved here.
test_amplification_file = 'test_amplification_fuji20NikonD850.txt'


# These are folders
save_images = 'images_fuji20NikonD850'  # Restored images will be saved here.
# Other details such as loss value and learning rate will be saved in this file.
save_csv_files = 'csv_files_fuji20NikonD850'
