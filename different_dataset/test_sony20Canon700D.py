...
metric_average_file = 'metric_average_sony20Canon700D.txt'
# Intermediate details for the test images, such as estimated amplification will be saved here.
test_amplification_file = 'test_amplification_sony20Canon700D.txt'


# These are folders
save_images = 'images_sony20Canon700D'  # Restored images will be saved here.
# Other details such as loss value and learning rate will be saved in this file.
save_csv_files = 'csv_files_sony20Canon700D'
...
checkpoint = torch.load('weights_sony20/weights_1000000', map_location=device)
