...
metric_average_file = 'metric_average_sony100Canon700D.txt'
# Intermediate details for the test images, such as estimated amplification will be saved here.
test_amplification_file = 'test_amplification_sony100Canon700D.txt'


# These are folders
save_images = 'images_sony100Canon700D'  # Restored images will be saved here.
# Other details such as loss value and learning rate will be saved in this file.
save_csv_files = 'csv_files_sony100Canon700D'
...
test_files = []
for i in range(10):
    test_files += glob.glob('CanonEOS700D/scene-'+str(i+1)+'/IMG_0005.CR2')

print(test_files)

gt_files = []
for i in range(10):
    gt_files += glob.glob('CanonEOS700D/scene-'+str(i+1)+'/IMG_0001.CR2')
...
checkpoint = torch.load('weights_sony100/weights_1000000', map_location=device)
