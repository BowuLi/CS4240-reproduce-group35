...
metric_average_file = 'metric_average_sony100Canon70D.txt'
# Intermediate details for the test images, such as estimated amplification will be saved here.
test_amplification_file = 'test_amplification_sony100Canon70D.txt'


# These are folders
save_images = 'images_sony100Canon70D'  # Restored images will be saved here.
# Other details such as loss value and learning rate will be saved in this file.
save_csv_files = 'csv_files_sony100Canon70D'
...
checkpoint = torch.load('weights_sony100/weights_1000000_pt', map_location=device)
